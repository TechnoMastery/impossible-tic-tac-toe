...
import net.minheur.impossibleTicTacToe.tabs.all.TicTacToeTab;

public class Tabs {
    private static final RegistryList<Tab> LIST = new RegistryList<>();

    // example tab
    public static final SmartSupplier<Tab> MY_TAB = LIST.add(() -> new Tab(new ResourceLocation(ImpossibleTicTacToe.MOD_ID, "ticTacToeTab"), TicTacToeTab.class));
